package me.sonam.friendship.web.health;
...
public class LivenessReadinessRouter {
    ...
    public RouterFunction<ServerResponse> route(LivenessReadinessHandler livenessReadinessHandler) {
        ...
        return RouterFunctions.route(GET("/friendships/api/health/liveness").and(accept(MediaType.APPLICATION_JSON)),
                livenessReadinessHandler::liveness)
                .andRoute(GET("/friendships/api/health/readiness").and(accept(MediaType.APPLICATION_JSON)),
